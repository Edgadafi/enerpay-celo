export const MICROFINANCE_POOL_ABI = [
  {
    "inputs": [
      {
    ...
    "outputs": [
      {
        "components": [
          ...
          {
            "internalType": "enum MicrofinancePool.LoanStatus",
            "name": "status",
            "type": "uint8"
          },
          {
        ...
        "internalType": "struct MicrofinancePool.Loan",
        "name": "",
        "type": "tuple"
      }
    ],
